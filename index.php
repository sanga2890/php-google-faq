...
<!-- creo l'array policies in cui inserirò le domande -->
<?php
...
$policies = [
    ...
    // // ciclo l'array con un ciclo foreach e stampo in pagina con echo;
    // foreach ($policies as $faq) {
    //     echo $faq['question'];
    //     echo "<br><br>";
    //     echo $faq['answer'];
    //     echo "<br><br><br>";
...
<!-- Creo la struttura Html per stampare in pagina -->
